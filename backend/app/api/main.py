...
from app.api.routes import pages, private, streaming, utils, video_caption
...
# WebSocket streaming for real-time meeting analysis
api_router.include_router(streaming.router, prefix="/streaming", tags=["streaming"])
# Video captioning with Moondream (video-only, no audio)
api_router.include_router(video_caption.router, prefix="/vision", tags=["vision"])
